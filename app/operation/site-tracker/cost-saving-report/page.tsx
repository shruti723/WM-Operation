...
type CostSavingRecord = {
    id: string
    site: string
    reductionSavingType: string | null
...
export default function CostSavingReportPage() {
    ...
    const [records, setRecords] = useState<CostSavingRecord[]>([])
    ...
    const fetchRecords = async () => {
        ...
        try {
            ...
            // Ravi should see only his own submitted reports.
            // Admin can remove this condition later if needed.
            ...
            const res = await fetch(`/api/operation/site-tracker/cost-saving-report?${params.toString()}`, {
                cache: "no-store",
            })
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch("/api/operation/site-tracker/cost-saving-report", {
                method: "POST",
                headers: {
            ...
            alert("Cost saving report submitted successfully")
                    ...
                    <div className="bg-emerald-50 border-b border-emerald-100 px-5 py-3 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                                Fill this form to submit a new cost saving entry.
                            </p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-5">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={form.reductionSavingType}
                                    onChange={handleChange}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    value={form.status}
                                    onChange={handleChange}
                                    className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 bg-white"
                                >
                        ...
                        <div className="mt-5 flex justify-end">
                            <button
                                type="submit"
                                disabled={submitting}
                                className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {submitting ? (
                    ...
                    <div className="px-5 py-4 border-t border-slate-200 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <ChevronLeft size={14} />
                                Previous
                            </button>
